...
export const ja: Translations = {
  ...
  commit: {
    ...
    closeIssue: 'マージ時にこのIssueを自動的に閉じますか?',
    issueWillClose: '✅ マージ後にIssue #{number}が閉じられます',
  ...
  pr: {
    ...
    generatingOptions: '🤖 {count} 個の PR 説明オプションを生成中...\n',
    generatedTitle: '📝 生成された PR タイトル:',
    generatedBody: '\n📝 生成された PR 説明:',
    generatedOptions: '📝 生成された PR オプション:',
    tips: '💡 ヒント:',
    ...
    selectedOption: '\n✨ PR オプション [{index}] を選択しました:\n',
    cancelled: '\n⚠️  PR 作成をキャンセルしました',
    optionTitle: '[{index}] {title}',
    selectedTitle: '選択されたタイトル',
    selectedBody: '選択された説明',
    platformTokenRequired: 'PR を作成するにはプラットフォームトークンが必要です',
  ...
  config: {
    ...
    updated: '✅ 設定が更新されました: {key}={value}',
    priority: '\n📊 設定優先順位: 環境変数 > プロジェクト設定 > グローバル設定 > デフォルト',
    activeSources: '\n🔍 アクティブな設定ソース:',
    runtimeOverridesActive: '⚡ ランタイムオーバーライド (環境変数から):',
    runtimeConfigTitle: 'ランタイム設定 (環境変数)',
    noRuntimeOverrides: '   アクティブなランタイムオーバーライドはありません',
    setEnvVarsHint: '   OPENAI_API_KEY、OPENAI_BASE_URL などの環境変数を設定してください',
    activeOverrides: 'アクティブなオーバーライド',
    envExampleTitle: '環境変数の例',
    runtimeDesc: 'ランタイム設定を表示 (環境変数)',
    setGlobalDesc: 'グローバル設定値を設定',
    initGlobalDesc: 'グローバル設定を初期化',
    initGlobal: 'グローバル設定を初期化中...',
    globalConfigExists: '⚠️  グローバル設定は既に存在します',
    globalConfigPath: '📁 グローバル設定パス: {path}',
    globalConfigCreated: '✅ グローバル設定を作成しました: {path}',
    globalInitSuccess: '🎉 グローバル設定の初期化が完了しました！',
    globalConfigInfo: '\n💡 プロジェクト固有の設定なしでQuartzコマンドを使用できます',
    globalConfig: 'グローバル設定',
    globalSetNotImplemented: '⚠️  グローバル設定値の設定はまだ実装されていません\n   ファイルを直接編集してください: {path}',
  },
  ...
  init: {
    ...
    globalConfigDetected: '🌍 グローバル設定が検出されました',
    canUseDirectly: '✓ プロジェクト固有の設定なしで Quartz コマンドを直接使用できます',
    projectConfigOptional: '⚠️  プロジェクト設定はグローバル設定を上書きします',
    noGlobalConfig: 'ℹ️  グローバル設定が見つかりません',
    suggestGlobal: '💡 ヒント: "quartz config init --global" でグローバル設定をセットアップしてください',
    confirmProjectConfig: '   その後、プロジェクト固有の初期化なしで任意のプロジェクトで Quartz を使用できます',
    onlyNeededIf: '💡 プロジェクト設定はオプションであり、次の場合にのみ必要です:',
    globalConfigHint: '   • このプロジェクトのグローバル設定を上書きしたい',
    globalConfigHint2: '   • このプロジェクトには異なる AI プロバイダーまたはプラットフォーム要件がある',
  },

  changelog: {
    starting: '🚀 変更履歴を生成中...',
    foundTags: '{count} 個のタグが見つかりました',
    generating: '変更履歴を生成中...',
    initial: '初回リリース',
    fetching: 'コミットを取得中...',
    found: '{count} 個のコミットが見つかりました',
    noCommits: 'コミットが見つかりません',
    preview: '変更履歴プレビュー:',
    saved: '変更履歴を保存しました: {path}',
    saveFailed: '変更履歴の保存に失敗しました',
    success: '変更履歴の生成が完了しました！',
    location: '場所',
  },
  ...
  branch: {
    ...
    suggestedName: '💡 推奨ブランチ名: {name}',
    useSuggestedName: '推奨ブランチ名を使用しますか？',
    ...
    forceDelete: '強制削除しますか (マージされていない変更を含む)？',
    ...
    noToken: '⚠️  プラットフォームトークンが設定されていないため、Issues を取得できません',
